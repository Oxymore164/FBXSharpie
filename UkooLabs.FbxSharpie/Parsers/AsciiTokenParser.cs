...
namespace UkooLabs.FbxSharpie.Parsers
{
	internal static class AsciiTokenParser
	{
		...
		public static bool TryParseIdentifierOrCharToken(FbxAsciiFileInfo fbxAsciiFileInfo, out Token token)
		{
			...
			if (identifier.Equals("T") || identifier.Equals("F") || identifier.Equals("Y") || identifier.Equals("N") || identifier.Equals("W") || identifier.Equals("ISO"))
			{
